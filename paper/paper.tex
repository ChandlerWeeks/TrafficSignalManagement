...
While simple observations provide great insight to the performance of our model, numbers to support our observations are potentially more important. As mentioned earlier, we developed several benchmarks based on the results of a simulation. Each benchmark provides a real insight that indicates the perforamnce of a traffic signal control method without the need to make observations. 
